    ...
    <nav className="navbarCustom fixed-top shadow">
      <div className="position-relative">
        ...
        <div className="d-flex justify-content-between align-items-center">
          {/* LEFT */}
          <div className="navbarLeft d-flex justify-content-center align-items-center ms-5">
            <Link to="/Guitars" className="navbarLink">
              Chitarre
            </Link>
            <i className="bi bi-dot fs-4 d-none d-md-block mx-lg-2"></i>
            <Link to="/Customshop" className="navbarLink">
              Custom shop
            </Link>
          </div>
          {/* RIGHT */}
          <div className="navbarRight d-flex align-items-center me-3 me-lg-5">
